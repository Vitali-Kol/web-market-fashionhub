...
type Item = {
  ...
  const items: Item[] = [
    { id: "naiste-uus-1", title: "\"Päikeseseen\" T-särk", price: "€39.90", src: "/icon/naiste-uus1.png" },
    { id: "naiste-uus-2", title: "\"Metsik Tiiger\" Huppar", price: "€69.90", src: "/icon/naiste-uus2.png" },
    { id: "naiste-uus-3", title: "\"Draakonituli\" Püksid", price: "€119.00", src: "/icon/naiste-uus3.png" },
    { id: "naiste-uus-4", title: "\"Kosmiline Tühjus\" Jope", price: "€59.90", src: "/icon/naiste-uus4.png" },
    { id: "naiste-uus-5", title: "\"Säde\" Müts", price: "€24.90", src: "/icon/naiste-uus5.png" },
    { id: "naiste-uus-6", title: "\"Linnakaru\" Mantel", price: "€139.00", src: "/icon/naiste-uus6.png" },
  ];
